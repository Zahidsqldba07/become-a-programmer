...
public class BugtrackerApplicationLoader implements ApplicationListener<ContextRefreshedEvent> {
        ...
        public void onApplicationEvent(ContextRefreshedEvent event) {
                ...
                Ticket tick1 = new Ticket("Add the ability to sort by release date", "The users need this new feature",
                                1, 2);
                ...
                Ticket tick3 = new Ticket("Provide a list of applications for users", "The users need this new feature",
                                2, 1);
                Ticket tick4 = new Ticket("Provide a list of tickets for an application",
                                "The users need this new feature", 2,
                                1);
                Ticket tick5 = new Ticket("Provide a list of tickets for a given release",
                                "The users need this new feature", 3,
                                4);
