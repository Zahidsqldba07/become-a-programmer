...
public class ApplicationRepositoryTests {
    ...
    public void testDeleteApplication() throws Exception {
        // prepare
        // no need to prepare data as data created is by
        // ApplicationCatalogApplicationLoader
    ...
    public void testUpdateApplication() throws Exception {
        ...
        // execute
        ResponseEntity<Application> responseEntity = restTemplate.exchange(URL + "/" + application.getId(),
